...
#define EINK_X_BUTTON_2_PIN GPIO(GPIO_PORTA, 0)
#define EINK_X_BUTTON_0_PIN GPIO(GPIO_PORTA, 9)
#define EINK_X_LED_0_PIN GPIO(GPIO_PORTA, 10)
...
#define EINK_X_LED_2_PIN GPIO(GPIO_PORTA, 23)
...
#define EINK_FMSDO GPIO(GPIO_PORTB, 10)
#define EINK_MFCSB GPIO(GPIO_PORTB, 11)
